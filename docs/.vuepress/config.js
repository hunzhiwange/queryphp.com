      ...
      children: [
        ...
        'component/seccode',
        {
          ...
          'children': [
            ...
            'component/http/apiresponse',
            'component/http/redirectresponse',
            'component/http/cookie',
            'component/http/file',
            'component/http/uploadedfile',
            'component/http/bag',
            'component/http/filebag',
            'component/http/serverbag',
            'component/http/headerbag',
            'component/http/responseheaderbag',
            'component/http/leevel2psr',
